...
- **Exercise:** whiteboard "Design Capital One's marketing website" (or the target company's)
...
- Explain trade-offs out loud; tie each answer back to your NBA.com / JPMC / Capital One work
...
- [x] Day 1  — Next.js App Router Foundations            → day01_nextjs_app_router.md
- [x] Day 2  — Next.js Rendering (SSR/SSG/ISR/streaming) → day02_nextjs_rendering.md
- [x] Day 3  — Data Fetching, Caching & 3rd-Party APIs   → day03_nextjs_data_caching.md
- [x] Day 4  — React Advanced & Performance              → day04_react_advanced_perf.md
- [x] Day 5  — TypeScript for React/Next                 → day05_typescript.md
- [x] Day 6  — Tailwind CSS in Depth                     → day06_tailwind.md
- [x] Day 7  — Design Systems: ShadCn, Radix, Figma      → day07_design_systems_shadcn.md
- [x] Day 8  — Accessibility (WCAG / A11y)               → day08_accessibility.md
- [x] Day 9  — Core Web Vitals & Performance             → day09_core_web_vitals.md
- [x] Day 10 — SEO for Next.js                           → day10_seo.md
- [x] Day 11 — Contentful / Headless CMS                 → day11_contentful_cms.md
- [x] Day 12 — Marketing Integrations & A/B Testing      → day12_marketing_integrations.md
- [x] Day 13 — CI/CD, Deployments & Branching            → day13_cicd_deployments.md
